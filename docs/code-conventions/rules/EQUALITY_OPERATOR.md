...
The current inventory of remaining production-code adjustments is tracked in
[`EQUALITY_OPERATOR.remaining.txt`](./EQUALITY_OPERATOR.remaining.txt).

- Last updated: 2026-03-30
- Open production occurrences: 314
- Source command: `npx eslint src --ext .ts,.tsx --rule 'eqeqeq:error' -f unix | rg -v '\.(spec|test)\.'`
