...
import { makeStyles, StandardTextFieldProps, TextField } from '@material-ui/core';
...
const ExpandingTextInput: React.FC<ExpandingTextInputProps> = (props): JSX.Element => {
...
const StyledTextInput: React.FC<StyledTextInputProps> = (props): JSX.Element => {
    ...
    return (
        <>
            <span ref={ hiddenInput } className={ classes.hiddenInput }>{ props.inputString }</span>
