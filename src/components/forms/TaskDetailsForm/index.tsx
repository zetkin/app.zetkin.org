...
const TaskDetailsForm = ({
  ...
  const validate = (values: ZetkinTaskRequestBody) => {
    ...
    if (!values.campaign_id) {
      errors.campaign_id = intl.formatMessage({
        id: 'misc.formDialog.required',
      });
    }
    if (
      ...
      errors.config = {};
      if (!config?.url) {
        errors.config.url = intl.formatMessage({
          id: 'misc.formDialog.required',
        });
      } else if (!validator.isURL(config.url, { require_protocol: true })) {
        errors.config.url = intl.formatMessage({
          id: 'misc.formDialog.invalidUrl',
        });
      }
    }
    ...
    if (!isPublishedFirst(values)) {
      errors.published = intl.formatMessage({
        id: 'misc.tasks.forms.createTask.fields.timeValidationErrors.publishedNotFirst',
      });
    }
    if (!isDeadlineSecond(values)) {
      errors.deadline = intl.formatMessage({
        id: 'misc.tasks.forms.createTask.fields.timeValidationErrors.deadlineNotSecond',
      });
    }
    if (!isExpiresThird(values)) {
      errors.expires = intl.formatMessage({
        id: 'misc.tasks.forms.createTask.fields.timeValidationErrors.expiresNotThird',
      });
    }
        ...
        <form noValidate onSubmit={handleSubmit}>
          ...
          <TextField
            ...
            label={intl.formatMessage({
              id: 'misc.tasks.forms.createTask.fields.campaign',
            })}
            margin="normal"
          ...
          <TextField
            ...
            id="title"
            label={intl.formatMessage({
              id: 'misc.tasks.forms.createTask.fields.title',
            })}
            margin="normal"
          ...
          <TextField
            ...
            label={intl.formatMessage({
              id: 'misc.tasks.forms.createTask.fields.instructions',
            })}
            margin="normal"
            multiline
          ...
          <TextField
            ...
            label={intl.formatMessage({
              id: 'misc.tasks.forms.createTask.fields.type',
            })}
            margin="normal"
          ...
          {values.type === TASK_TYPE.WATCH_VIDEO && <WatchVideoFields />}
