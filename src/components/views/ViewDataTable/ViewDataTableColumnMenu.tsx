...
>(function ViewDataTableColumnMenuComponent(props, ref) {
    ...
    return (
        <GridColumnMenuContainer
            ...
            <MenuItem data-testid={ `rename-column-button-${currentColumn.field}` }
            ...
            </MenuItem>
            {
                ...
                props.showConfigureButton(currentColumn.field) && (
                    <MenuItem onClick={ noPropagate(() => onConfigure(currentColumn.field)) }>
                        <Msg id="misc.views.columnMenu.configure"/>
                    </MenuItem>
                )
            }
            <MenuItem data-testid={ `delete-column-button-${currentColumn.field}` }
