...
import ZetkinDate from './../Date';
import { ZetkinJourneyInstance } from 'utils/types/zetkin';

export interface JourneyInstanceItemProps {
  instance:
...
const JourneyInstanceItem: React.FC<JourneyInstanceItemProps> = ({
  instance,
  orgId,
}) => {
...
export default JourneyInstanceItem;
