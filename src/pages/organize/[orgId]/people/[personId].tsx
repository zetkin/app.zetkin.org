...
type OrganizePersonPageProps = {
    orgId: string;
};

const OrganizePersonPage : PageWithLayout<OrganizePersonPageProps> = () => {
    return (
        <Heading level={ 1 }>
            specific person page content
        </Heading>
    );
};
...
export default OrganizePersonPage;
