...
const VisitAssignmentAssigneesList = ({
  assignees,
  onCustomize,
  onRemove,
}: {
  assignees: ZetkinVisitAssignee[];
  onCustomize: (assignee: ZetkinVisitAssignee) => void;
  onRemove: (assignee: ZetkinVisitAssignee) => void;
}) => {
  const messages = useMessages(messageIds);
  const { orgId } = useRouter().query;

  const columns: GridColDef<ZetkinVisitAssignee>[] = [
    {
...
export default VisitAssignmentAssigneesList;
