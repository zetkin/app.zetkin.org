...
export default makeMessages('feat.surveys', {
  ...
  insights: {
    ...
    optionsFields: {
      ...
      subheaderSingleChoice: m<{
        answerCount: number;
        optionsCount: number;
      }>(
        'In total, there were {answerCount, plural, =1 {1 answer} other {# answers}} across {optionsCount, plural, =1 {1 option} other {# options}}.'
      ),
      tabs: {
        barPlot: m('Bar'),
        piePlot: m('Pie'),
