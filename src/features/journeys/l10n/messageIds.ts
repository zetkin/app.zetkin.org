...
export default makeMessages('feat.journeys', {
  instance: {
    ...
    created: m<{ relative: ReactElement<any> }>('Created {relative}'),
    deadlineLabel: m<{ date: ReactElement<any> }>('(Was due {date})'),
    ...
    markedCompleteLabel: m<{ relativeTime: ReactElement<any> }>(
    ...
    updated: m<{ relative: ReactElement<any> }>('last activity {relative}'),
  },
  instances: {
    columns: {
