...
export const getStaticColumns = (
  ...
  return [
    ...
    },
    {
      ...
      valueFormatter: (value) => getPeopleString(value as ZetkinPersonType[]),
    },
    {
      field: 'subjects',
      filterOperators: [
    ...
    },
    {
      ...
      valueGetter: (value, row) =>
        (row as ZetkinJourneyInstance).next_milestone?.title,
    },
    {
      ...
      valueFormatter: (value) => new Date(value),
      valueGetter: (value, row) =>
        (row as ZetkinJourneyInstance).next_milestone?.deadline,
    },
    {
      field: 'summary',
    },
