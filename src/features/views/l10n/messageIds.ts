...
export default makeMessages('feat.views', {
  ...
  browser: {
    backToFolder: m<{ folder: ReactElement<any> }>('Back to {folder}'),
    ...
    moveToFolder: m<{ folder: ReactElement<any> }>('Move to {folder}'),
  ...
  deleteRowsDialog: {
    ...
    instruction: m<{ rootOrgSlug: ReactElement<any> }>(
      'To confirm you understand the consequences, type {rootOrgSlug} in the textbox below.'
    ),
    tagetOrgWarning: m<{ rootOrgTitle: ReactElement<any> }>(
  ...
  shareDialog: {
    download: {
      ...
      warning2: m<{ shareLink: ReactElement<any> }>(
    ...
    share: {
      ...
      collabInstructions: m<{ viewLink: ReactElement<any> }>(
